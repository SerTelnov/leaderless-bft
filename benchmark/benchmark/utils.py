...
class PathMaker:
    ...
    @staticmethod
    def benchmark_file():
        return '.benchmark.yaml'

    @staticmethod
    def key_file(i):
        assert isinstance(i, int) and i >= 0
        return f'.peer-{i}.json'
    ...
    @staticmethod
    def peer_log_file(name):
        return join(PathMaker.logs_path(), f'{name}.log')

    @staticmethod
    def coordinator_log_file():
        return join(PathMaker.logs_path(), f'coordinator.log')
